...
static const float BOT_BASE_R   = 2.3f;  
static const float BOT_BASE_H   = 0.8f;


static const int   STRIPE_COUNT = 4;       
static const float FR_BOT       = 2.0f;    
static const float FR_TOP       = 1.0f;    
static const float FR_H         = 3.5f;    


static const float SKIRT_INNER  = FR_TOP;
static const float SKIRT_OUTER  = FR_TOP + 0.25f;
static const float SKIRT_Y      = BOT_BASE_H + FR_H; 
...
static const float HBASE_H      = 0.2f; 
